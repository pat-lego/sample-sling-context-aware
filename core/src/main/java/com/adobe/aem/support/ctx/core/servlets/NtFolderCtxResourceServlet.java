...
@SlingServletResourceTypes(resourceTypes = "nt:folder", methods = HttpConstants.METHOD_GET, extensions = "json", selectors = "ctx")
@ServiceDescription("Simple Demo Servlet")
public class NtFolderCtxResourceServlet extends SlingSafeMethodsServlet {
