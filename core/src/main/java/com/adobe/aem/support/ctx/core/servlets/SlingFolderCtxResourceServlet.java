...
@SlingServletResourceTypes(resourceTypes = JcrResourceConstants.NT_SLING_FOLDER, methods = HttpConstants.METHOD_GET, extensions = "json", selectors = "ctx")
@ServiceDescription("Simple Demo Servlet")
public class SlingFolderCtxResourceServlet extends SlingSafeMethodsServlet {
